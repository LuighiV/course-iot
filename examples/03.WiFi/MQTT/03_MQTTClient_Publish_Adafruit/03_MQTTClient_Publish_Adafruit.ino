...
void reconnect()
{
  ...
  while (!mqttClient.connected()) 
  {
    ...
    if (mqttClient.connect(clientID,mqttUserName,mqttPass)) 
    {
      ...
      String topic = String(mqttUserName)+ "/feeds/diplomado-iot.led-control";
...
void mqttPublishFeed(){
  ...
  String topic1= String(mqttUserName)+ "/feeds/diplomado-iot.humedad";
  mqttClient.publish(topic1.c_str(), h_char);
  
  String topic2= String(mqttUserName)+ "/feeds/diplomado-iot.temperatura";
